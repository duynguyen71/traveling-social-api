...
public interface ChatGroupRepository extends JpaRepository<ChatGroup, Long> {
    ...
    List<ChatGroup> findByUsers_UserAndUsers_StatusAndStatus(User user, Integer chatUserStatus,Integer status, Pageable pageable);
    ...
    @Query(
            nativeQuery = true,
            value = "SELECT cg.* FROM chat_group_user cgu\n" +
