...
public class ReviewPostHelper {
    ...
    /**
     * Search Review Post by Title, Content, Tag Name, Location label
     */
    public ResponseEntity<?> searchReviewPosts(Map<String, String> param) {
        ...
        List<ReviewPost> posts = reviewPostService.searchReviewPostsNative("%" + keyWord + "%", pageable);
        List<BaseReviewPostResponse> data = posts.stream()
                .map(reviewPost ->
                {
                    BaseReviewPostResponse map = modelMapper.map(reviewPost, BaseReviewPostResponse.class);
                    Location location = reviewPost.getLocation();
                    if (location != null) {
                        map.setLocation(location.getLabel());
                    }
                    return map;
    ...
    /**
     * Get saved Review Post bookmarks sort by create date DESC
     */
    ...
    public ResponseEntity<?> getReviewPostAuthor(Long reviewId) {
